...
public class Thutienhocphi extends StandardEntity {
    ...
    @OneToMany(mappedBy = "ten_thutienhocphi")
    private List<Chitietthu> lkchitietthu;

    public List<Chitietthu> getLkchitietthu() {
        return lkchitietthu;
    }

    public void setLkchitietthu(List<Chitietthu> lkchitietthu) {
        this.lkchitietthu = lkchitietthu;
    }
